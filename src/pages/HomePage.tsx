    ...
    <div className="space-y-6">
      ...
      <div className="bg-hotel-navy text-white p-4 md:p-8 rounded-lg shadow-lg">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-xl md:text-2xl font-semibold text-hotel-gold">Bem-vindo ao Painel de Gestão</h2>
          ...
          <div className="mt-4 md:mt-6">
            <Button 
              ...
              className="w-full md:w-auto bg-hotel-gold text-hotel-navy hover:bg-hotel-lightgold" 

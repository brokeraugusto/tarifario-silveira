      ...
      <div className="bg-hotel-navy text-white p-4 md:p-8 rounded-lg shadow-lg">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-4 md:mt-6">
            <Button variant="secondary" size={isMobile ? "default" : "lg"} onClick={() => navigate('/search')} className="w-full md:w-auto bg-hotel-gold text-hotel-navy hover:bg-hotel-lightgold text-zinc-800 text-center">

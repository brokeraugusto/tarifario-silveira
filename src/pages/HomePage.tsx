...
const HomePage = () => {
  ...
  return <div className="space-y-8">
      <div className="text-center pt-10 pb-6">
        <h1 className="text-4xl font-bold text-hotel-navy">Tarifário Silveira Eco Village</h1>
      ...
      <div className="bg-hotel-navy text-white p-8 rounded-lg shadow-lg">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-6">
            <Button variant="secondary" size="lg" className="bg-hotel-gold text-hotel-navy hover:bg-hotel-lightgold" onClick={() => navigate('/search')}>

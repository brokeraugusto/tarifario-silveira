...
const PeriodsList: React.FC<PeriodsListProps> = ({
  ...
  return <div className="space-y-4">
      <div className="flex justify-between items-center">
        ...
        <Button onClick={handleAddClick} disabled={isButtonsDisabled} title="Adicionar novo período" className="bg-primary hover:bg-primary/90">
      ...
      {loading ? <div className="text-center py-8">
        ...
        </div> : <MultiSelectTable data={periods} columns={periodColumns} getRowId={row => row.id} onEdit={handleEditPeriods} onDelete={handleDeletePeriods} onSelectedRowsChange={handleSelectionChange} />}
    </div>;
};

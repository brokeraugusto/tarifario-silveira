...
const Layout = ({
  ...
  return <div className="min-h-screen flex flex-col md:flex-row">
      {isMobile ? <>
          ...
          <aside className="text-sidebar-foreground min-h-screen w-[250px] fixed left-0 top-0 bottom-0 overflow-y-auto bg-neutral-700">
            ...
            <nav className="p-4">
              <ul className="space-y-2">
                <li>
                  <NavLink to="/" className={({
                isActive
              }) => cn("flex items-center p-2 rounded-md transition-colors", isActive ? "bg-sidebar-primary text-sidebar-primary-foreground font-medium" : "hover:bg-sidebar-accent/20")} end>
                    <Home className="w-5 h-5 mr-2" />
                    <span>Início</span>
                  </NavLink>
                </li>
